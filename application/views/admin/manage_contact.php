            ...
            <div class="app-content">
                <section class="section">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a  class="text-muted">Contact Us</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>View All Contacts    
                                    </h4>
                                    <a class="btn btn-danger mconbtn" href="" onclick="delete_link('contact/<?php echo base64_encode(base64_encode(0)); ?>')" data-toggle="modal" data-target="#exampleModal">Delete All Records</a>
                                </div>
                                <div class="card-body ">
                                            ...
                                            <tbody >
                                                ...
                                                foreach ($contact as $data){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: middle;" align="center"><?php echo $data->subject; ?></td>
                                                        <td style="vertical-align: middle;" align="center"><?php echo $data->message; ?></td>
                                                        <td style="vertical-align: middle;" align="center">
                                                            <a href="" onclick="delete_link('contact/<?php echo base64_encode(base64_encode($data->contact_id)); ?>')" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-trash-o" style="color:red;font-size:20px" data-toggle="tooltip" data-placement="bottom" title="Remove Data"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
