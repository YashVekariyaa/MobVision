...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Forget Password - Mob Vision</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="account_form">
                            ...
                            <p>Enter the registerd email so we can send your password via email</p>
                            <form action="" novalidate="" method="post" name="forget" class="myform">
                                <p>
                                ...
                                <div class="login_submit">
                                    <a href="<?php base_url(); ?>login-register">Back to Login</a>
